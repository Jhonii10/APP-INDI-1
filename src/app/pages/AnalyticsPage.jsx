...
import {
  ...
  AppCurrentSubject,
  AppConversionRates,
} from '../components/secctions/@dashboard/analytics';
...
export default function AnalyticsPage() {
  ...
  return (
    <>
      {/* <Helmet>
        <title> Dashboard |  Analitys </title>
      </Helmet> */}
      ...
      <Container maxWidth="xl">
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} sm={6} md={3}>
            <AppWidgetSummary title="Usuarios nuevos" total={1352831} color="info" icon={'ant-design:apple-filled'} />
          </Grid>
          ...
          <Grid item xs={12} md={6} lg={8}>
            <AppTasks
              title="Tareas"
              list={[
                { id: '1', label: 'Crear logotipo de FireStone' },
                { id: '2', label: 'Agregar archivos SCSS y JS si es necesario' },
                { id: '3', label: 'Reunión de Partes Interesadas' },
                { id: '4', label: 'Alcance y Estimaciones' },
                { id: '5', label: 'Demostración de Sprint' },
              ]}
            />
          </Grid>
        </Grid>
