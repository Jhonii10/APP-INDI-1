...
const Navbar = () => {
    ...
    return (
        <div>
            <header className="absolute z-9 top-0 left-0 w-full h-28 p-3 flex flex-row items-center justify-between bg-transparent z-10 ">
  <div className="w-full flex h-28  items-center gap-8 px-8 sm:px-6 lg:px-20">
    ...
    <div className="flex space-x-4  md:flex lg:flex h-16">
            ...
            {isDropdownOpen && (
              ...
              <ul
                className="absolute mt-2 py-2 bg-white border border-black w-full right-0 top-10 dropdown-menu"
                onMouseEnter={() => setIsDropdownOpen(true)}
                onMouseLeave={() => setIsDropdownOpen(false)}
              >
                {menuItems.map((item) => (
